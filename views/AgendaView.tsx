    ...
    <div className="flex flex-col animate-in fade-in duration-500 h-full relative">
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-[100] flex flex-col justify-end">
          ...
          <div className="bg-white dark:bg-[#0a0a0a] border-t border-black/10 dark:border-white/10 w-full rounded-t-[40px] p-6 pb-12 space-y-6 relative z-10 animate-in slide-in-from-bottom duration-300 max-h-[95dvh] overflow-y-auto hide-scrollbar">
            <div className="w-12 h-1.5 bg-black/10 dark:bg-white/10 rounded-full mx-auto mb-2 shrink-0"></div>
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-black text-black dark:text-white tracking-tight">Novo Agendamento</h3>
              <button onClick={() => setShowAddModal(false)} className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/5 flex items-center justify-center text-black/40 dark:text-white/40"><X size={20} /></button>
            </div>
